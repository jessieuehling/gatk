...
//        final String outputPrefix = "test";
        ...
        final String outputPrefix = "wgs-matched-gtfix-cronly-mbcr";
...
//                .addArgument(ModelSegments.NUMBER_OF_BURN_IN_SAMPLES_COPY_RATIO_LONG_NAME, "250")
//                .addArgument(ModelSegments.NUMBER_OF_SAMPLES_COPY_RATIO_LONG_NAME, "500")
                .addOutput(outputDir)
